...
global.reloadHandler = async function(restatConn) {
  ...
  conn.welcome = '*╔══════════════*\n*╟❧ @subject*\n*╠══════════════*\n*╟❧ @user*\n*╟❧ 𝐖𝐄𝐋𝐂𝐎𝐌𝐄/𝙰* \n*║*\n*╟❧ 𝐆𝐑𝐎𝐔𝐏 𝐃𝐄𝐒𝐂𝐑𝐈𝐏𝐓𝐈𝐎𝐍:*\n\n@desc\n\n*║*\n*╟❧ 𝐄𝐍𝐉𝐎𝐘 𝐘𝐎𝐔𝐑 𝐒𝐓𝐀𝐘!!*\n*╚══════════════*';
  conn.bye = '*╔══════════════*\n*╟❧ @user*\n*╟❧ 𝐒𝐄𝐄 𝐘𝐎𝐔 𝐒𝐎𝐎𝐍 👋🏻* \n*╚══════════════*';
  conn.spromote = '*@user JOINS THE ADMINS SQUAD, SOMEONE ADDED A PERSON TO THE ADMINS PANEL!!*';
  conn.sdemote = '*@user LEAVES ADMINS SQUAD, SOMEONE DISMISSED ONE OF THE ADMINS !!*';
