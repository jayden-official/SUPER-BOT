...
let msg = `https://github.com/jayden-official *[❗𝐈𝐍𝐅𝐎❗] correct use of command  ${usedPrefix + command} (idioma) (texto)*\n*example:*\n*${usedPrefix + command} en Hello*\n\n*𝙲𝙾𝙽𝙾𝙲𝙴 𝙻𝙾𝚂 𝙸𝙳𝙸𝙾𝙼𝙰𝚂 𝙰𝙳𝙼𝙸𝚃𝙸𝙳𝙾𝚂 𝙴𝙽:*\n*- https://cloud.google.com/translate/docs/languages*`
...
await m.reply('https://github.com/jayden-official *translation:* ' + result.text)
} catch {
try {    
