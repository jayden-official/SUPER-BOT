...
if (!text) throw `https://github.com/jayden-official *[❗𝐈𝐍𝐅𝐎❗] enter a Twitter link, example: ${usedPrefix + command}* https://twitter.com/auronplay/status/1586487664274206720?s=20&t=3snvkvwGUIez5iWYQAehpw` 
try {
...
throw 'https://github.com/jayden-official *[❗𝐈𝐍𝐅𝐎❗] 𝙴𝚁𝚁𝙾𝚁, please try again later*'  
}}}
handler.command = /^((twdl|tw|twt|twitter)(dl)?)$/i
export default handler
async function twitterDl(url) {
let id = /twitter\.com\/[^/]+\/status\/(\d+)/.exec(url)?.[1]
if (!id) throw 'https://github.com/jayden-official *[❗𝐈𝐍𝐅𝐎❗] enter a valid twitter link, example: #twitter* https://twitter.com/auronplay/status/1586487664274206720?s=20&t=3snvkvwGUIez5iWYQAehpw'
...
}} else throw 'https://github.com/jayden-official *[❗𝐈𝐍𝐅𝐎❗] 𝙴𝚁𝚁𝙾𝚁, please try again later *' }
