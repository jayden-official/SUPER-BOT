...
const handler = async (m, { command, usedPrefix, conn, text }) => {
  if (!text) throw `_*< 🐝BUMBLEBEE - PLAY2🐝 />*_\n\n*[ ℹ️ ] The title of the YouTube video is missing.*\n\n*[ 💡 ] Example:* _${usedPrefix + command} Good Feeling - Flo Rida_\ n\n*[ 💡 ] Example 2:* _${usedPrefix + command} https://youtu.be/JLWRZ8eWyZo?si=EmeS9fJvS_OkDk7p_`;
if (enviando) return;
    enviando = true
  try {
    const apiUrls = [
