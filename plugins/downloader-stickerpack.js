...
if (!text) throw `*[❗]  example  USING the command ${usedPrefix + command}* https://getstickerpack.com/stickers/flork-memes-4-1`
try {
let url = text
...
await m.reply('*[❗] 𝙴𝚁𝚁𝙾𝚁, please try again later*')  
}}
