...
if (!text) throw `https://github.com/Khalid-official *[❗]  example  USING the command ${usedPrefix + command}* https://getstickerpack.com/stickers/flork-memes-4-1`
try {
let url = text
...
await m.reply('https://github.com/Khalid-official *[❗] 𝙴𝚁𝚁𝙾𝚁, please try again later*')  
}}
