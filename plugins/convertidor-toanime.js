...
if (!/image/g.test(mime)) throw '*[❗] RESPOND TO AN IMAGE SIR!!*'
m.reply('*[❗] CONVERTING IMAGE TO ANIME DESIGN, BE PATIENT AS I SEND THE RESULT*')    
...
throw '*[❗]ERROR, PELEASE VERIFY IF THE IMAGE IS VISIBLE'
}}}}
