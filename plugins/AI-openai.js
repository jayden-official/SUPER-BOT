...
const handler = async (m, {conn, text, usedPrefix, command}) => {
  ...
  try {
      ...
      try {
        conn.sendPresenceUpdate('composing', m.chat);
        const syms1 = `You will act as a WhatsApp Bot which was created by Jayden-techs, you will be The SUPER Bot-md.`;
