...
conn.reply(m.chat, '*‼️THERE ARE STILL UNANSWERED BIBLE QUESTIONS IN THE CHAT‼️*', conn.tekateki[id][0])
throw false
}
...
poin,
setTimeout(async () => {
if (conn.tekateki[id]) await conn.reply(m.chat, `*OPPS❗TIME IS OVER*!\n*Answer:* ${json.response}`, conn.tekateki[id][0])
