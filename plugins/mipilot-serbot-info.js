...
const replyMessage = (message.length === 0) ? "https://github.com/Khalid-official *NO SUB BOTS AVAILABLE. CHECK LATER.*" : message
await m.reply( 'https://github.com/Khalid-official *—◉ HERE IS THE LIST OF ACTIVE SUBBOTS (SERBOT/JADIBOT) 🤖️*\n\n*◉ YOU CAN CONTACT THEM TO ASK THEM TO JOIN YOUR GROUP, BE RESPECTFUL!!*\n\n*[❗] THE SHADOW BROKERS- TEAM DISCLAIMS ALL LIABILITY OR EVENTS OCCURRED WITH REGARD TO THE BOT OR SUBBOTS*')
