...
if (!/(mp4)/.test(mime)) throw `https://github.com/Khalid-official *[❗]  the file type ${mime}  is not correct, please reply to a video that you want to convert into a gif with audio*`
m.reply(global.wait)
