...
let textoInfo = `*[❗] You can download the video you want in the following way:*
...
↳ 📥 *_Uploaded :_* ${v.ago}
↳ 👁 *_Views :_* ${v.views}`}).join('\n\n◦◦◦◦◦◦◦◦◦◦◦◦◦◦◦◦◦◦◦ ◦◦◦◦\n\n')
conn.sendFile(m.chat, results.all[0].thumbnail, 'yts.jpeg', textoInfo + '\n\n' + teks, m)
global.videoList.push(vids_);
} catch {    
await m.reply('*[❗𝐈𝐍𝐅𝐎❗] ERROR, PLEASE TRY AGAIN WITH ANOTHER SONG NAME*')  
}}
