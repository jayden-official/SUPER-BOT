...
let handler = async (m, { conn, usedPrefix, command }) => {
  ...
  if (new Date - global.db.data.users[m.sender].lastwork < 3600000) throw `https://github.com/jayden-official *🧘🏻‍♂️ You are tired* and therefore you have to wait *${msToTime(time - new Date())}* to work again!`
