...
if (!db.data.chats[m.chat].modohorny && m.isGroup) throw '*[❗𝐈𝐍𝐅𝐎❗] LOS COMANDOS +18 ESTAN DESACTIVADOS EN ESTE GRUPO , SI ES ADMIN  Y DESEA ACTIVARLOS USE EL COMANDO  #enable modohorny*'
switch (command) {
case "pack": 
