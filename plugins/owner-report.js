const handler = async (m, {conn, text, usedPrefix, command}) => {
  if (!text) throw `*[❗𝐈𝐍𝐅𝐎❗] ENTER A REPORT*\n\n*EXAMPLE:*\n*${usedPrefix + command} the command ${usedPrefix}bot is not playing music*`;
  if (text.length < 10) throw `*[❗𝐈𝐍𝐅𝐎❗] THE REPORT MUST BE AT LEAST 10 CHARACTERS!*`;
  if (text.length > 1000) throw `*[❗𝐈𝐍𝐅𝐎❗] THE REPORT MUST BE A MAXIMUM OF 1000 CHARACTERS!*`;
