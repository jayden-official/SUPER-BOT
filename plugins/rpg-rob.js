...
let handler = async (m, { conn, usedPrefix, command}) => {
    ...
    if (new Date - global.db.data.users[m.sender].lastrob < 7200000) throw `https://github.com/jayden-official ⏱️Hey! Wait *${msToTime(time - new Date())}* to steal again`
    let who
    if (m.isGroup) who = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : false
    else who = m.chat
     if (!who) throw `https://github.com/jayden-official ✳️ Tag someone to steal`
