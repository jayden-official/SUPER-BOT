...
if (new Date - user.lastclaim < 7200000) return await conn.reply(m.chat, `you already claimed your gift 🎁\ngo back in*${msToTime(time - new Date())}* to claim again`, fkontak, m)
