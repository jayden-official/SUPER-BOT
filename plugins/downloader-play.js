...
if (!text) throw `*[❗𝐈𝐍𝐅𝐎❗] MISSING SONG NAME PLEASE ENTER E COMNO PLUS THE NAME/TITLE OF A SONG*\n\n*—◉ EXAMPLE:*\n*${usedPrefix + command} Good Feeling - Flo Rida*`
try {
...
await conn.reply(m.chat, '*[❗] ERROR, NO POSSIBLE AUDIO FOUND*', m)}}}
}  
if (command == 'play2') {
try {
let qu = '360'
...
await conn.sendMessage(m.chat, { video: { url: mediaa.result }, fileName: `error.mp4`, caption: `_THE BUMBLEBEE BOT_`, thumbnail: mediaa.thumb, mimetype: 'video/mp4' }, { quoted: m })     
} catch {  
try {
...
throw "*[❗𝐈𝐍𝐅𝐎❗] ERROR, PLEASE TRY AGAIN LATER*"}
}
